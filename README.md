...
When the scedhuled airflow jobs execute, it reads realtime camera feeds and runs object detection and tracking algorithms and store bounding box coordinates (bottom left) of pedestrians in Mongodb. 

<p align="center">
  <img width="1000" height="375" src="https://github.com/arsalhuda24/MLOps-Realtime-Trajectory-Prediction/blob/master/images/mongodb_snapshot.png">
</p>
