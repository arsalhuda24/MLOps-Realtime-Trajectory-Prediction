...
agnostic_nms = False
augment = False
classes = 0#[0,2] #0 #for only pedestrians 
conf_thres = 0.3
...
visualize = False;
# yolo_model = "/home/asyed/my_docker/Yolov5_DeepSort_Pytorch/yolov5/yolov5m.pt"
yolo_model = "/home/asyed/my_docker/Yolov5_DeepSort_Pytorch/yolov5/crowdhuman_yolov5m.pt"
# yolo_model = "/home/asyed/my_docker/Yolov5_DeepSort_Pytorch/yolov6n.pt"
webcam = True
# save_vid = True
save_txt = True
